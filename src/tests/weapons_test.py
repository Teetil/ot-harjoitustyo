...
class TestWeapon(unittest.TestCase):
    ...
    def test_get_nearest_works(self):
        res = self.test_weapon.get_nearest(self.player, [self.enemy])
    ...
    def test_upgrade_random_works(self):
        ...
        self.assertEqual(1.1, self.test_weapon.proj_attrs["damage"])
        self.test_weapon.upgrade_random()
        self.assertEqual(0.9, self.test_weapon.cooldown)
        self.test_weapon.upgrade_random()
        self.assertEqual(2, self.test_weapon.quantity)

...
class ProjectileTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.test_projectile = Projectile((10, 10), pygame.Vector2(15, 15), (0, 0, 0), self.proj_attrs)
    
    def test_move_works(self):
        self.test_projectile.move()
        self.assertEqual((12, 12), (self.test_projectile.rect.x, self.test_projectile.rect.y))
    
    def test_normal_hit_works(self):
        self.test_projectile.hit(self.enemies)

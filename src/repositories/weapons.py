...
class Weapon:
    ...
    def get_nearest(self, player, enemies):
        ...
        for enemy in enemies:
            enemy_vect.append(pygame.math.Vector2(enemy.rect.centerx - player.rect.centerx, enemy.rect.centery - player.rect.centery))
...
class Fireball(Weapon):
    def __init__(self, damage, cooldown, proj_speed, area, quantity) -> None:
        super().__init__(damage, cooldown, proj_speed, area, quantity)